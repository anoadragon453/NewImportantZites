			...
			<div class="nav-wrapper">
				<div class="container">
					...
					<ul id="mobile-nav" class="sidenav">
						...
						<li style="margin-bottom: 10px;"><a class="collection-item" :class="{ 'active': false }" :href="'./?/zite/zerome'" v-on:click.prevent="goto('zite/zerome');">ZeroMe</a></li>
						<li><a class="collection-item"></a></li>
					</ul>
				</div>
			</div>
		</nav>
