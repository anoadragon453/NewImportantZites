<template>
	<div id="importZite" class="container">
		<div class="row">
	        <div class="col s12 m12 l9">
	        	<!--<component :is="topic_navbar" active="ask" :user-info="userInfo"></component>-->
	        	<div class="card">
	        		<div class="card-content">
	        			<span class="card-title">{{ langTranslation["Add Zite"] }}</span>
...
<script>
	...
	module.exports = {
		props: ["userInfo", "ziteToImport", "langTranslation"],
		name: "ImportZite",
		data: () => {
			return {
			...
			getInfo: function(userInfo) {
				...
				page.getCategories()
					.then((categories) => {
                        ...
                        self.title = self.ziteToImport.title;
                        self.titleChanged();
