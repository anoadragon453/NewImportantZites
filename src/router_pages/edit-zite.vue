	...
	module.exports = {
		...
		methods: {
            ...
            editZite: function() {
                ...
                page.editZite(this.id, this.title, this.address, this.domain, this.creator, this.description, tags, this.category, this.mergerSupported, this.mergerCategory, this.languages.join(","), () => {
					Router.navigate("");
				});
			},
