						...
						<form onsubmit="return false;">
							<div class="row" style="padding: 0; margin: 0; height: 100%;">
								<div class="input-field col s10 m11 l12" style="display: inline-block; margin: 0; padding: 0;">
									<input id="search" type="search" placeholder="Search Zites" v-on:keyup.enter="searchEnter($event)" v-on:input.prevent="getZites" v-model="searchQuery" required style="margin: 0;">
